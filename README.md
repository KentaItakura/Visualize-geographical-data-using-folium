...
また、pythonコードの部分は、[こちらのnbviewer](https://nbviewer.org/github/KentaItakura/Visualize-geographical-data-using-folium/blob/main/Choropleth_Folium.ipynb)でも閲覧可能です。
